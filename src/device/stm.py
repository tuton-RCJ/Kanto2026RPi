...
class STMUART:
    ...
    def requestActuatorControl(self,type: deviceEnums.ActuatorControlType,data:bytes)->bool:
...
class STS3032:
    ...
    def setMotorSpeed(self, motorSpeed: dict[deviceEnums.Side, int]) -> bool:
        ...
        return stmUART.requestActuatorControl(deviceEnums.ActuatorControlType.STS_MOTOR, data)
...
class RescueKitServo:
    ...
    def dropRescueKit(self, num: int, side: deviceEnums.Side):
        ...
        stmUART.requestActuatorControl(deviceEnums.ActuatorControlType.RESCUE_KIT,
                                        data)
